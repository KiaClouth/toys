...
// >>>>>  STEP 3 <<<<<
FONTS['PangMenZhengDao'] = PMZ(codeList)
FONTS['Helvetica-Black-SemiBold'] = HBSB(codeList)
FONTS['ZiHunMengQuRuanTangTi'] = ZHMQRTT(codeList)
FONTS['YouSheBiaoTiHei-2'] = YSBTH(codeList)
FONTS['YSbiaotiyuan'] = YSBTY(codeList)
